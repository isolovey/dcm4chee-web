 ...
 * @version $Revision: 18338 $ $Date: 2011-07-12 15:37:33 +0200 (Di, 12 Jul
 *          2011) $
 * @since Aug 5, 2010
 */
public class WebCfgDelegate extends BaseCfgDelegate {
    ...
    public boolean getDefaultLatestMwlItemsFirst() {
		return getBoolean("DefaultLatestMwlItemsFirst", false);
	}

	public boolean getDefaultLatestStudiesFirst() {
		return getBoolean("DefaultLatestStudiesFirst", false);
	}
