 ...
 * @since 18.03.2011
 */
public class MaskingAjaxCallBehavior extends AbstractBehavior implements IHeaderContributor {
    ...
    public void renderHead(IHeaderResponse response) {
        response.renderJavascriptReference(new ResourceReference(BaseWicketPage.class, "web3-utils.js"));
    }
